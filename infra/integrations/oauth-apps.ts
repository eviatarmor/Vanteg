...
function app(
  ...
  return {
    ...
    authorizeUrl,
    tokenUrl,
    redirectPath: `/integrations/oauth/${id}/callback`,
    scopes,
  }
}
...
export const oauthApps: OAuthApp[] = [
  ...
  app(
    ...
    ["channels:read", "chat:write", "reactions:write", "users:read"]
  ),
  app(
    "github",
    "GitHub",
...
export function getOAuthApp(id: string): OAuthApp | undefined {
...
export function terraformOAuthApps(): Record<string, TerraformOAuthApp> {
