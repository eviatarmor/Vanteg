...
export function AppShell() {
  ...
  return (
    <SidebarProvider className="h-svh overflow-hidden bg-sidebar">
      <a
        href="#main-content"
        className="absolute top-4 left-4 z-50 -translate-y-16 rounded-lg border border-transparent bg-background px-3 py-2 text-sm font-medium text-foreground opacity-0 shadow-md ring-ring/50 transition outline-none focus:translate-y-0 focus:border-ring focus:opacity-100 focus:ring-3 focus-visible:border-ring focus-visible:opacity-100 focus-visible:ring-3 focus-visible:ring-ring/50"
        onClick={(event) => {
